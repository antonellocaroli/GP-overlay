...
SRC_URI="
amd64? ( https://www.signalyst.eu/bins/hqplayerd/buster/${MY_PN}_${PV}-50_amd64.deb )
arm64? ( https://www.signalyst.eu/bins/hqplayerd/buster/${MY_PN}_${PV}-50_arm64.deb )
"
...
src_prepare() {
     ...
     patchelf --replace-needed libomp.so.5 libomp.so usr/bin/hqplayerd || die
		 patchelf --replace-needed libgupnp-1.0.so.4 libgupnp-1.2.so usr/bin/hqplayerd || die
}
