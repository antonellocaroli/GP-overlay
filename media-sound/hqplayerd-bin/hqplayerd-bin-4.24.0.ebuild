...
SRC_URI="
amd64? ( !cpu_flags_x86_avx2? ( https://www.signalyst.eu/bins/hqplayerd/fc30/${MY_PN}-${PV}-61.fc30.x86_64.rpm ) )
amd64? ( cpu_flags_x86_avx2? ( https://www.signalyst.eu/bins/hqplayerd/fc33/${MY_PN}-${PV}-61.fc33.x86_64.rpm ) )
"
