...
SRC_URI="
amd64? ( https://www.signalyst.eu/bins/hqplayerd/buster/${MY_PN}_${PV}-45_amd64.deb )
arm64? ( https://www.signalyst.eu/bins/hqplayerd/buster/${MY_PN}_${PV}-45_arm64.deb )
"
...
src_prepare() {
     default
     patchelf --replace-needed libomp.so.5 libomp.so "{D}usr/bin/hqplayerd" || die
}
