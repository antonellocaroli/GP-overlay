...
SRC_URI="
amd64? ( !cpu_flags_x86_avx2? ( http://www.signalyst.eu/bins/hqplayer/focal/${MY_PN}_${PV}-45_amd64.deb ) )
amd64? ( cpu_flags_x86_avx2? ( http://www.signalyst.eu/bins/hqplayer/focal/${MY_PN}_${PV}-46amd_amd64.deb ) )
"
